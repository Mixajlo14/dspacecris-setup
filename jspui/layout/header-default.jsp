...
<% if (supportedLocales != null && supportedLocales.length > 1)
 ...
 %>		
       ...
       <div class="col-sm-2 hidden-xs pull-<%= isRtl ?"right" :"left" %>"><img class="img-responsive" src="<%= request.getContextPath() %>/image/logoUNScrn.png" alt="DSpace logo" />
 		</div>
		<div style="padding-top: 25px; font-family: Calibri;" class="col-sm-10 brand pull-<%= isRtl ?"left" :"right" %>">
